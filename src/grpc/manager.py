...
from loguru import logger as loguru_logger  # <-- ဒီ line ထည့်ပါ (အမှားပျောက်ဖို့)
...
class WrapperManager:
    ...
    @retry(retry=((retry_if_exception_type(WrapperManagerException)) & (
           ...
           stop=stop_after_attempt(32), before_sleep=before_sleep_log(loguru_logger, "WARNING"))  # <-- ဒီလို ပြောင်း
